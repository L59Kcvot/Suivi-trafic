...
# URL officielle PRIM IDFM pour l'état des lignes
URL_API = "https://prim.iledefrance-mobilites.fr/marketplace/v2/navitia/line_reports/line_reports"
# Ta clé d'API directement intégrée pour le script
...
def update_data():
    ...
    for report in raw_data.get("line_reports", []):
        line_id = report.get("line", {}).get("id")
    ...
    print("🤖 Mode Robot : Données trafic et Historique actualisés avec succès !")
